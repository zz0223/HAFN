...
class InpaintGenerator(BaseNetwork):
    def __init__(self, config=None, residual_blocks=8, init_weights=True):
        ...
        self.encoder0 = nn.Sequential(
            ...
            nn.Conv2d(in_channels=3+1, out_channels=64, kernel_size=7, padding=0),
        ...
        #self.kp_diation = KernelConv2(kernel_size=[3], sep_conv=False, core_bias=False)
        self.kpn_model1 = kpn_utils.create_generator1()
        self.kpn_model2 = kpn_utils.create_generator2()
    ...
    def forward(self, x):
        ...
        kernels,c1,c2,c3 = self.kpn_model1(inputs, x)
        ...
        kernels_img = self.kpn_model2(x,c1,c2,c3)
        ...
        #x = self.kp_diation(x, kernels_img, white_level=1.0, rate=1)
        x = (torch.tanh(x) + 1) / 2
